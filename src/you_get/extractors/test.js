...
function get_signature(__ac_nonce){
    res = window.byted_acrawler.sign("", __ac_nonce)
    return res 
}

//新增一个导出函数（node方式）
module.exports.init = function (__ac_nonce) {
    //调用函数，并返回
    sign = get_signature(__ac_nonce)
    return sign
